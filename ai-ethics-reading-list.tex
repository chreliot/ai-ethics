...
%% Define a command “\weektitle” that uses the \weeknumber counter to auto-number weekly section headings
...
%% Define a command “\readings” that prints a bibliography for the section (especially, for one week) with no heading
...
\begin{itemize}[nosep, label=\textbullet]
  ...
  \item Ways of thinking about rights
...
\begin{itemize}[nosep, label=\textbullet]
  \item Arguments about the possibility of a right to work
...
\begin{itemize}[nosep, label=\textbullet]
  \item Why would we care about our environment?
